...
const textQuestions: QuestionSeed[] = [
  ...
  textQuestion('fr-quiz-004', 1, 'Format TTMC découverte : quelle ville est associée à la basilique Notre-Dame de la Garde ?', ['Marseille', 'Nantes', 'Dijon', 'Rouen'], 0, 'Notre-Dame de la Garde domine Marseille.', ['ville', 'monument'], 'https://fr.wikipedia.org/wiki/Notre-Dame-de-la-Garde'),
  ...
  textQuestion('fr-quiz-009', 2, 'Style TTMC intermédiaire : quelle île est au large de la Charente-Maritime ?', ['Île d’Oléron', 'Belle-Île-en-Mer', 'Porquerolles', 'Île de Bréhat'], 0, 'L’île d’Oléron se trouve sur la façade atlantique, en Charente-Maritime.', ['ile'], 'https://fr.wikipedia.org/wiki/%C3%8Ele_d%27Ol%C3%A9ron'),
