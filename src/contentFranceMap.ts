...
const mapEntries: MapEntry[] = [
  ...
  { id: 'fr-map-020', difficulty: 3, prompt: 'Carte de France dédiée : place la Camargue.', label: 'Camargue', lat: 43.53, lon: 4.5, toleranceKm: 55, explanation: 'La Camargue est le delta du Rhône, entre Arles et la Méditerranée.', tags: ['delta', 'rhone'], learnMoreUrl: 'https://fr.wikipedia.org/wiki/Camargue' },
...
const textQuestions: QuestionSeed[] = [
  ...
  textQuestion('fr-quiz-009', 3, 'Style TTMC niveau 7 : quelle île est au large de la Charente-Maritime ?', ['Île d’Oléron', 'Belle-Île-en-Mer', 'Porquerolles', 'Île de Bréhat'], 0, 'L’île d’Oléron se trouve sur la façade atlantique, en Charente-Maritime.', ['ile'], 'https://fr.wikipedia.org/wiki/%C3%8Ele_d%27Ol%C3%A9ron'),
  textQuestion('fr-quiz-010', 3, 'Question pour un champion : je suis le delta du Rhône. Qui suis-je ?', ['La Sologne', 'La Camargue', 'Le Morvan', 'La Beauce'], 1, 'La Camargue correspond au delta du Rhône.', ['delta', 'rhone'], 'https://fr.wikipedia.org/wiki/Camargue'),
  textQuestion('fr-quiz-011', 3, 'Placement France : quelle ville est la plus proche de la frontière allemande ?', ['Bordeaux', 'Nantes', 'Strasbourg', 'Toulouse'], 2, 'Strasbourg est située sur le Rhin, face à l’Allemagne.', ['frontiere', 'placement'], 'https://fr.wikipedia.org/wiki/Strasbourg'),
...
const departmentQuestions: QuestionSeed[] = [
  ...
  freeTextQuestion('fr-dept-007', 3, 'Quel est le numéro du département du Finistère ?', ['29'], 'Le Finistère porte le numéro 29; ce code identifie la pointe occidentale de la Bretagne.', ['departement', 'numero'], 'https://fr.wikipedia.org/wiki/Finist%C3%A8re'),
  freeTextQuestion('fr-dept-008', 3, 'Quel code départemental désigne la Corse-du-Sud ?', ['2a'], 'La Corse-du-Sud utilise le code 2A; la lettre distingue ce département de la Haute-Corse.', ['departement', 'numero', 'corse'], 'https://fr.wikipedia.org/wiki/Corse-du-Sud'),
  freeTextQuestion('fr-dept-009', 3, 'Quel code départemental désigne la Haute-Corse ?', ['2b'], 'La Haute-Corse utilise le code 2B; la lettre distingue ce département de la Corse-du-Sud.', ['departement', 'numero', 'corse'], 'https://fr.wikipedia.org/wiki/Haute-Corse'),
];
