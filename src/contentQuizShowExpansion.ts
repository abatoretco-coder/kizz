...
export const quizShowExpansionQuestions: QuestionSeed[] = [
  ...
  choice(['show-sci-004', 'science', 1, 'Format découverte : quel gaz est majoritaire dans l atmosphere terrestre ?', ['Oxygene', 'Azote', 'Argon', 'Dioxyde de carbone'], 1, 'L azote represente environ 78 % de l atmosphere terrestre.', ['chimie', 'atmosphere'], 'https://fr.wikipedia.org/wiki/Atmosph%C3%A8re_terrestre']),
