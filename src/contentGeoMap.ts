...
const entries: GeoEntry[] = [
  ...
  { id: 'geo-map-029', difficulty: 3, prompt: 'Place Wellington sur la carte du monde.', label: 'Wellington', lat: -41.2865, lon: 174.7762, toleranceKm: 340, explanation: 'Wellington est à l’extrémité sud de l’île du Nord en Nouvelle-Zélande.', tags: ['carte', 'capitale', 'oceanie'], learnMoreUrl: 'https://fr.wikipedia.org/wiki/Wellington' },
  { id: 'geo-map-030', difficulty: 3, prompt: 'Place Anchorage sur la carte du monde.', label: 'Anchorage', lat: 61.2181, lon: -149.9003, toleranceKm: 340, explanation: 'Anchorage est dans le sud de l’Alaska, près du golfe d’Alaska.', tags: ['carte', 'ville', 'amerique'], learnMoreUrl: 'https://fr.wikipedia.org/wiki/Anchorage' },
  { id: 'geo-country-001', difficulty: 1, prompt: 'Carte du monde : place le Japon.', label: 'Japon', lat: 36.2, lon: 138.3, toleranceKm: 650, explanation: 'Le Japon est un archipel d’Asie orientale, à l’est de la péninsule coréenne.', tags: ['carte', 'pays', 'asie'], learnMoreUrl: 'https://fr.wikipedia.org/wiki/Japon' },
  { id: 'geo-country-002', difficulty: 1, prompt: 'Carte du monde : place le Brésil.', label: 'Brésil', lat: -10.8, lon: -53.0, toleranceKm: 1100, explanation: 'Le Brésil occupe une grande partie de l’Amérique du Sud.', tags: ['carte', 'pays', 'amerique'], learnMoreUrl: 'https://fr.wikipedia.org/wiki/Br%C3%A9sil' },
  { id: 'geo-country-003', difficulty: 1, prompt: 'Carte du monde : place l’Australie.', label: 'Australie', lat: -25.3, lon: 133.8, toleranceKm: 1000, explanation: 'L’Australie se situe entre océan Indien et océan Pacifique.', tags: ['carte', 'pays', 'oceanie'], learnMoreUrl: 'https://fr.wikipedia.org/wiki/Australie' },
  { id: 'geo-country-004', difficulty: 2, prompt: 'Carte du monde : place l’Inde.', label: 'Inde', lat: 22.9, lon: 79.6, toleranceKm: 850, explanation: 'L’Inde occupe une grande partie du sous-continent indien.', tags: ['carte', 'pays', 'asie'], learnMoreUrl: 'https://fr.wikipedia.org/wiki/Inde' },
  { id: 'geo-country-005', difficulty: 2, prompt: 'Carte du monde : place l’Égypte.', label: 'Égypte', lat: 26.8, lon: 30.8, toleranceKm: 650, explanation: 'L’Égypte est au nord-est de l’Afrique, autour du Nil.', tags: ['carte', 'pays', 'afrique'], learnMoreUrl: 'https://fr.wikipedia.org/wiki/%C3%89gypte' },
  { id: 'geo-country-006', difficulty: 2, prompt: 'Carte du monde : place le Canada.', label: 'Canada', lat: 56.1, lon: -106.3, toleranceKm: 1400, explanation: 'Le Canada couvre le nord de l’Amérique du Nord.', tags: ['carte', 'pays', 'amerique'], learnMoreUrl: 'https://fr.wikipedia.org/wiki/Canada' },
  { id: 'geo-region-001', difficulty: 2, prompt: 'Carte du monde : place la Scandinavie.', label: 'Scandinavie', lat: 62.0, lon: 14.5, toleranceKm: 750, explanation: 'La Scandinavie désigne le nord de l’Europe autour de la Norvège, de la Suède et du Danemark selon les usages.', tags: ['carte', 'region-monde', 'europe'], learnMoreUrl: 'https://fr.wikipedia.org/wiki/Scandinavie' },
  { id: 'geo-region-002', difficulty: 2, prompt: 'Carte du monde : place l’Asie du Sud-Est.', label: 'Asie du Sud-Est', lat: 12.5, lon: 105.0, toleranceKm: 950, explanation: 'L’Asie du Sud-Est se situe entre Inde, Chine et Océanie.', tags: ['carte', 'region-monde', 'asie'], learnMoreUrl: 'https://fr.wikipedia.org/wiki/Asie_du_Sud-Est' },
  { id: 'geo-region-003', difficulty: 3, prompt: 'Carte du monde : place le Maghreb.', label: 'Maghreb', lat: 30.5, lon: 2.0, toleranceKm: 900, explanation: 'Le Maghreb couvre le nord-ouest de l’Afrique, notamment Maroc, Algérie et Tunisie.', tags: ['carte', 'region-monde', 'afrique'], learnMoreUrl: 'https://fr.wikipedia.org/wiki/Maghreb' },
  { id: 'geo-region-004', difficulty: 3, prompt: 'Carte du monde : place les Balkans.', label: 'Balkans', lat: 43.2, lon: 21.0, toleranceKm: 650, explanation: 'Les Balkans correspondent au sud-est de l’Europe.', tags: ['carte', 'region-monde', 'europe'], learnMoreUrl: 'https://fr.wikipedia.org/wiki/Balkans' },
  { id: 'geo-region-005', difficulty: 3, prompt: 'Carte du monde : place le Caucase.', label: 'Caucase', lat: 42.5, lon: 44.5, toleranceKm: 520, explanation: 'Le Caucase se situe entre mer Noire et mer Caspienne.', tags: ['carte', 'region-monde', 'caucase'], learnMoreUrl: 'https://fr.wikipedia.org/wiki/Caucase' },
  { id: 'geo-region-006', difficulty: 3, prompt: 'Carte du monde : place l’Afrique australe.', label: 'Afrique australe', lat: -24.0, lon: 24.0, toleranceKm: 1000, explanation: 'L’Afrique australe correspond à la partie sud du continent africain.', tags: ['carte', 'region-monde', 'afrique'], learnMoreUrl: 'https://fr.wikipedia.org/wiki/Afrique_australe' },
];
