...
const entries: GeoEntry[] = [
  ...
  { id: 'geo-country-001', difficulty: 1, prompt: 'Carte du monde : place le Japon.', label: 'Japon', lat: 36.2, lon: 138.3, toleranceKm: 650, explanation: 'Le Japon est un archipel d Asie orientale, a l est de la peninsule coreenne.', tags: ['carte', 'pays', 'asie'], learnMoreUrl: 'https://fr.wikipedia.org/wiki/Japon' },
  { id: 'geo-country-002', difficulty: 1, prompt: 'Carte du monde : place le Bresil.', label: 'Bresil', lat: -10.8, lon: -53.0, toleranceKm: 1100, explanation: 'Le Bresil occupe une grande partie de l Amerique du Sud.', tags: ['carte', 'pays', 'amerique'], learnMoreUrl: 'https://fr.wikipedia.org/wiki/Br%C3%A9sil' },
  { id: 'geo-country-003', difficulty: 1, prompt: 'Carte du monde : place l Australie.', label: 'Australie', lat: -25.3, lon: 133.8, toleranceKm: 1000, explanation: 'L Australie se situe entre ocean Indien et ocean Pacifique.', tags: ['carte', 'pays', 'oceanie'], learnMoreUrl: 'https://fr.wikipedia.org/wiki/Australie' },
  ...
  { id: 'geo-country-005', difficulty: 2, prompt: 'Carte du monde : place l Egypte.', label: 'Egypte', lat: 26.8, lon: 30.8, toleranceKm: 650, explanation: 'L Egypte est au nord-est de l Afrique, autour du Nil.', tags: ['carte', 'pays', 'afrique'], learnMoreUrl: 'https://fr.wikipedia.org/wiki/%C3%89gypte' },
  { id: 'geo-country-006', difficulty: 2, prompt: 'Carte du monde : place le Canada.', label: 'Canada', lat: 56.1, lon: -106.3, toleranceKm: 1400, explanation: 'Le Canada couvre le nord de l Amerique du Nord.', tags: ['carte', 'pays', 'amerique'], learnMoreUrl: 'https://fr.wikipedia.org/wiki/Canada' },
  { id: 'geo-region-001', difficulty: 2, prompt: 'Carte du monde : place la Scandinavie.', label: 'Scandinavie', lat: 62.0, lon: 14.5, toleranceKm: 750, explanation: 'La Scandinavie designe le nord de l Europe autour de la Norvege, de la Suede et du Danemark selon les usages.', tags: ['carte', 'region-monde', 'europe'], learnMoreUrl: 'https://fr.wikipedia.org/wiki/Scandinavie' },
  { id: 'geo-region-002', difficulty: 2, prompt: 'Carte du monde : place l Asie du Sud-Est.', label: 'Asie du Sud-Est', lat: 12.5, lon: 105.0, toleranceKm: 950, explanation: 'L Asie du Sud-Est se situe entre Inde, Chine et Oceanie.', tags: ['carte', 'region-monde', 'asie'], learnMoreUrl: 'https://fr.wikipedia.org/wiki/Asie_du_Sud-Est' },
  { id: 'geo-region-003', difficulty: 3, prompt: 'Carte du monde : place le Maghreb.', label: 'Maghreb', lat: 30.5, lon: 2.0, toleranceKm: 900, explanation: 'Le Maghreb couvre le nord-ouest de l Afrique, notamment Maroc, Algerie et Tunisie.', tags: ['carte', 'region-monde', 'afrique'], learnMoreUrl: 'https://fr.wikipedia.org/wiki/Maghreb' },
  ...
  { id: 'geo-region-006', difficulty: 3, prompt: 'Carte du monde : place l Afrique australe.', label: 'Afrique australe', lat: -24.0, lon: 24.0, toleranceKm: 1000, explanation: 'L Afrique australe correspond a la partie sud du continent africain.', tags: ['carte', 'region-monde', 'afrique'], learnMoreUrl: 'https://fr.wikipedia.org/wiki/Afrique_australe' },
];
