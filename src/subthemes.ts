...
export const subthemes: Subtheme[] = [
  ...
  { id: 'opentdb-general', topicId: 'opentdb-general', title: 'Culture générale', tag: 'subtheme:opentdb:general' },
  { id: 'opentdb-books', topicId: 'opentdb-books', title: 'Livres', tag: 'subtheme:opentdb:books' },
  { id: 'opentdb-film', topicId: 'opentdb-film', title: 'Cinéma', tag: 'subtheme:opentdb:film' },
  { id: 'opentdb-music', topicId: 'opentdb-music', title: 'Musique', tag: 'subtheme:opentdb:music' },
  { id: 'opentdb-tv', topicId: 'opentdb-tv', title: 'Télévision', tag: 'subtheme:opentdb:tv' },
  { id: 'opentdb-games', topicId: 'opentdb-games', title: 'Jeux vidéo', tag: 'subtheme:opentdb:games' },
  { id: 'opentdb-board-games', topicId: 'opentdb-board-games', title: 'Jeux de société', tag: 'subtheme:opentdb:board-games' },
  { id: 'opentdb-science-nature', topicId: 'opentdb-science-nature', title: 'Sciences et nature', tag: 'subtheme:opentdb:science-nature' },
  { id: 'opentdb-computers', topicId: 'opentdb-computers', title: 'Informatique', tag: 'subtheme:opentdb:computers' },
  { id: 'opentdb-math', topicId: 'opentdb-math', title: 'Mathématiques', tag: 'subtheme:opentdb:math' },
  { id: 'opentdb-mythology', topicId: 'opentdb-mythology', title: 'Mythologie', tag: 'subtheme:opentdb:mythology' },
  { id: 'opentdb-sports', topicId: 'opentdb-sports', title: 'Sport', tag: 'subtheme:opentdb:sports' },
  { id: 'opentdb-geography', topicId: 'opentdb-geography', title: 'Géographie', tag: 'subtheme:opentdb:geography' },
  { id: 'opentdb-history', topicId: 'opentdb-history', title: 'Histoire', tag: 'subtheme:opentdb:history' },
  { id: 'opentdb-politics', topicId: 'opentdb-politics', title: 'Politique', tag: 'subtheme:opentdb:politics' },
  { id: 'opentdb-art', topicId: 'opentdb-art', title: 'Arts', tag: 'subtheme:opentdb:art' },
  { id: 'opentdb-animals', topicId: 'opentdb-animals', title: 'Animaux', tag: 'subtheme:opentdb:animals' },
  { id: 'opentdb-vehicles', topicId: 'opentdb-vehicles', title: 'Véhicules', tag: 'subtheme:opentdb:vehicles' },
  { id: 'opentdb-comics', topicId: 'opentdb-comics', title: 'Comics', tag: 'subtheme:opentdb:comics' },
  { id: 'opentdb-anime-manga', topicId: 'opentdb-anime-manga', title: 'Anime et manga', tag: 'subtheme:opentdb:anime-manga' },
  { id: 'opentdb-animation', topicId: 'opentdb-animation', title: 'Animation', tag: 'subtheme:opentdb:animation' },
];
